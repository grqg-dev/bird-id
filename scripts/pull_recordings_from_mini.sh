#!/usr/bin/env bash
# Pull segment wavs from the Mac mini for local testing (identify, dashboard playback).
#
# Default: 30 newest seg_*.wav files (~hundreds of MB, not the full ~2.7GB dir).
#
# Usage:
...
#   ./scripts/pull_recordings_from_mini.sh seg_20260601_131822.wav seg_20260601_132044.wav
#
